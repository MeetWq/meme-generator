...
def stick(images: list[BuildImage], texts, args):
    ...
    # fmt: off
    user_locs = [
        (108, 15), (107, 14), (104, 16), (102, 14), (104, 15), (108, 15), (108, 15), (103, 16), (102, 15), (104, 14)
    ]
    self_locs = [
        (78, 120), (115, 130), (0, 0), (110, 100), (80, 100), (75, 115), (105, 127), (0, 0), (110, 98), (80, 105)
]
    rotate_num = [
        -48, -18, 0, 38, 31, -43, -22, 0, 34, 35
    ]
    # fmt: on
    frames: list[IMG] = []
    for i in range(10):
        ...
        frame.paste(img, self_locs[i], alpha=True, below=True)
