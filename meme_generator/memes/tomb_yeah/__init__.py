...
def tomb_yeah(images: List[BuildImage], texts, args):
    ...
    frame.paste(images[0].convert("RGBA").circle().resize((145, 145)), (138, 265), alpha=True)
    if len(images) > 1:
        frame.paste(images[1].convert("RGBA").circle().rotate(30).resize((145, 145)), (371, 312), alpha=True)  
