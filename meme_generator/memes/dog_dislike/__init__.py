...
def dog_dislike(images: List[BuildImage], texts: List[str], args: Model):
    location = [(36, 408), (36, 410), (40, 375),
    (40, 355), (36, 325), (28, 305),
    (28, 305), (28, 305), (28, 305),
    (28, 285), (28, 285), (28, 285),
    (28, 285), (28, 290), (30, 295),
    (30, 300), (30, 300), (30, 300),
    (30, 300), (30, 300), (30, 300),
    (28, 298), (26, 296), (24, 294),
    (28, 294), (26, 294), (24, 294),
    (35, 294), (115, 330), (150, 355),
    (180, 420), (180, 450), (150, 450),
    (150, 450),]
    head = (
        images[0]
        .convert("RGBA")
