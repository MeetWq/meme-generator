...
def arona_throw(images: list[BuildImage], texts, args):
    position_list = [
            (270,295),(154,291),(154,291),(89,211),
            (41,195),(28,192),(16,200),(-10,206),
            (-40,210),(-80,214),(324,245),(324,256),
            (331,251),(331,251),(318,260),(318,260),
        ]
    position_list2 = [
        (324,15),(324,106),(324,161),(324,192),
    ]
    def maker(i: int) -> Maker:
        def make(imgs: list[BuildImage]) -> BuildImage:
            pyroxenes = imgs[0].convert("RGBA").resize((120,120), keep_ratio=True).circle()
    ...
    return make_gif_or_combined_gif(
        images, maker, 16, 0.04, FrameAlignPolicy.no_extend
    )
